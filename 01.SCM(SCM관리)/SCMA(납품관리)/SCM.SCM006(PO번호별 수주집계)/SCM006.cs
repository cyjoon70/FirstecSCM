...
namespace SCM.SCM006
{
    public partial class SCM006 : UIForm.FPCOMM1 
    {
        ...
        #region Form Load 시
        private void SCM006_Load(object sender, System.EventArgs e)
        {
        ...
        private void btnCustCd_Click(object sender, EventArgs e)
        {
            try
            {
                string strQuery = " usp_SCM006 @pTYPE = 'P3' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void btnProjectNo_Click(object sender, EventArgs e)
        {
            try
            {
                string strQuery = " usp_SCM006 @pTYPE = 'P4' , @pCUST_CD='" + txtCustCd.Text + "' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void btnItemNo_Click(object sender, EventArgs e)
        {
            try
            {
                string strQuery = " usp_SCM006 @pTYPE = 'P2' , @pLANG_CD='" + SystemBase.Base.gstrLangCd + "', @pCUST_CD='" + txtCustCd.Text + "' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    string strQuery = " usp_SCM006 @pTYPE= 'S1'";
