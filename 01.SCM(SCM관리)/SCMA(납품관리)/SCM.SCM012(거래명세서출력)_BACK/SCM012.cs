        ...
        private void c1Button1_Click(object sender, EventArgs e)
        {
            ...
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                try
                {
                    ...
                    if (rdoStatus_1.Checked == true)
                    {
                        string[] RptParmValue = new string[11];   // SP 파라메타 값  // 2016.10.04. hma 수정: 배열수 9=>11
                        RptName = SystemBase.Base.ProgramWhere + @"\Report\SCM009_1.rpt";    // 레포트경로+레포트명
                        RptParmValue[0] = "S5";     // 2016.10.04. hma 수정: S1=>S5
                        RptParmValue[1] = SystemBase.Base.gstrCOMCD;
                        RptParmValue[2] = SystemBase.Base.gstrLangCd;
                        RptParmValue[3] = "";
                        ...
                        RptParmValue[6] = "";
                        // 2016.10.04. hma 수정(Start): 새로운 매개변수인 @pSTART_DT, @pEND_DT에 저장되도록 함
                        //RptParmValue[7] = dtpMvmtDtFr.Text;
                        //RptParmValue[8] = dtpMvmtDtTo.Text;
                        RptParmValue[7] = "";
                        RptParmValue[8] = "";
                        RptParmValue[9] = dtpMvmtDtFr.Text;
                        RptParmValue[10] = dtpMvmtDtTo.Text;
                        // 2016.10.04. hma 추가(End)
                    ...
                    else
                    {
                        ...
                        RptParmValue[0] = "S6";     // 2016.10.04. hma 수정: S3=>S6
                        RptParmValue[1] = SystemBase.Base.gstrCOMCD;
                        RptParmValue[2] = SystemBase.Base.gstrLangCd;
                        RptParmValue[3] = "";
                        RptParmValue[4] = txtCustCd.Text;
