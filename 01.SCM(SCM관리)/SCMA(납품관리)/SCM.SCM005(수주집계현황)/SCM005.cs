...
{
    public partial class SCM005 : UIForm.FPCOMM1 
    {
        ...
        #region Form Load 시
        private void SCM005_Load(object sender, System.EventArgs e)
        {
            ...
            txtPoDtFr.Text = Convert.ToDateTime(SystemBase.Base.ServerTime("YYMMDD")).AddMonths(-1).ToShortDateString().Substring(0,7);
            txtPoDtTo.Text = SystemBase.Base.ServerTime("YYMMDD").Substring(0, 7);
        ...
        private void btnCustCd_Click(object sender, EventArgs e)
        {
            try
            {
                string strQuery = " usp_SCM005 @pTYPE = 'P3' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void btnProjectNo_Click(object sender, EventArgs e)
        {
            try
            {
                string strQuery = " usp_SCM005 @pTYPE = 'P4' , @pCUST_CD='" + txtCustCd.Text + "' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        private void btnItemNo_Click(object sender, EventArgs e)
        {
            try
            {
                string strQuery = " usp_SCM005 @pTYPE = 'P2' , @pLANG_CD='" + SystemBase.Base.gstrLangCd + "', @pCUST_CD='" + txtCustCd.Text + "' , @pCO_CD='" + SystemBase.Base.gstrCOMCD + "'";
        ...
        protected override void SearchExec()
        {
            ...
            try
            {
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    string strQuery = " usp_SCM005 @pTYPE= '" + div + "'";
                    strQuery += ", @pPO_DT_FR = '" + txtPoDtFr.Text + "-01'";
                    strQuery += ", @pPO_DT_TO = '" + txtPoDtTo.Text + "-01'";

                    if (txtDeliveryDtFr.Text == "" || txtDeliveryDtTo.Text == "")
                    {
                    ...
                    {
                        strQuery += ", @pDELIVERY_DT_FR = '" + txtDeliveryDtFr.Text + "-01'";
                        strQuery += ", @pDELIVERY_DT_TO = '" + txtDeliveryDtTo.Text + "-01'";
                    }
