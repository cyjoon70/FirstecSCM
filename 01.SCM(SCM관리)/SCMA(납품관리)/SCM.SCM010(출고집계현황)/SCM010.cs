...
{ 
    public partial class SCM010 : UIForm.FPCOMM1
    {
        #region 생성자
        public SCM010()
        {
        ...
        #region Form Load
        private void SCM010_Load(object sender, EventArgs e)
        {
        ...
        private void Search(string strPoNo)
        {
            ...
            try
            {
                ...
                {
                    var div = "";
                    if (rdoStatus_1.Checked == true) div = "S1";
					else if(rdoStatus_2.Checked == true) div = "S2";

                    var Cfm = "";
					if(rdoBasis_Scm.Checked == true) Cfm = "1";

                    string Query = " usp_SCM010 @pType='" + div + "'";
                    Query += ", @pBASIS_DT_FR = '" + dtpBasisDtFr.Text + "'";
                    Query += ", @pBASIS_DT_TO = '" + dtpBasisDtTo.Text + "'";
                    Query += ", @pBASIS_DT_CFM = '" + Cfm + "'";
