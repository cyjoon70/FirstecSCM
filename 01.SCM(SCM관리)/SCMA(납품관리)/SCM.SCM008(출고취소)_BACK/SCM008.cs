                ...
                try
                {
                    ...
                    for (int i = 0; i < fpSpread1.Sheets[0].Rows.Count; i++)
                    {
                        ...
                        if (strHead.Length > 0)
                        {
                            ...
                            string strQuery = " usp_SCM008 '" + strGbn + "'";
                            strQuery += ", @pSCM_MVMT_NO = '" + fpSpread1.Sheets[0].Cells[i, 20].Value + "'";
                            strQuery += ", @pPO_NO = '" + fpSpread1.Sheets[0].Cells[i, 1].Value + "'";
                            strQuery += ", @pPO_SEQ = '" + fpSpread1.Sheets[0].Cells[i, 2].Value + "'";
