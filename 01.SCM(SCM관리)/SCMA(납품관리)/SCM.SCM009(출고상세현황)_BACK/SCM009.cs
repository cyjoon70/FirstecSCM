...
namespace SCM.SCM009
{
    public partial class SCM009 : UIForm.FPCOMM2
    {
        #region 생성자
        public SCM009()
        {
        ...
        #region Form Load
        private void SCM009_Load(object sender, EventArgs e)
        {
        ...
        private void Search(string strPoNo)
        {
            ...
            try
            {
                if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
                {
                    ...
                    string Query = " usp_SCM009 @pType = '" + Cfm + "'";
                    ...
                    Query += ", @pSCM_MVMT_NO = '" + txtScmNo.Text + "'";
                    ...
                    {                       
                        UIForm.FPMake.grdCommSheet(fpSpread1, Query, G2Head1, G2Head2, G2Head3, G2Width, G2Align, G2Type, G2Color, G2Etc, G2HeadCnt, false, false, 0, 0);
                    }
                }
            }
            catch (Exception f)
        ...
        /*
        #region 레포트 출력
        private void butPreview_Click_1(object sender, EventArgs e)
        {
            //조회 필수 체크
            if (SystemBase.Validation.GroupBox_SaveSearchValidation(groupBox1))
            {
                try
                {
                    ...
                    if (rdoBasis_Scm.Checked == true)
                    {
                        ...
                        {
                            Cfm = "S1";
                            RptName = SystemBase.Base.ProgramWhere + @"\Report\SCM009_1.rpt";
                        }
                        else
                        {
                            Cfm = "S3";
                            RptName = SystemBase.Base.ProgramWhere + @"\Report\SCM009_2.rpt";
                        }
                    ...
                    RptParmValue[5] = txtProjectNo.Text;
                    RptParmValue[6] = txtScmNo.Text;

                    RptParmValue[7] = dtpBasisDtFr.Text;
                    RptParmValue[8] = dtpBasisDtTo.Text;
