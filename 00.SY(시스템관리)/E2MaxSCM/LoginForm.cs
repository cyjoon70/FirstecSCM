                ...
                else
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (Encode == txtPW.Text)
                        {
                            ...
                            //SystemBase.Base.gstrDbName = "MTMS_20170921";   // 2018.02.28. hma 임시 추가  => 다시 주석 처리함.
                            //strDbName = "MTMS_20170921";        // 2018.02.28. hma 임시 추가  => 다시 주석 처리함.
                            //SetIniValue("DATABASE", "Database", SystemBase.Base.gstrDbName, SystemBase.Base.ProgramWhere + "\\E2MAX_SCM_FTP.ini");// 2018.02.28. hma 임시 추가  => 다시 주석 처리함.
